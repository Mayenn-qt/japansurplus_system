...
<div class="sidebar d-flex flex-column justify-content-between p-3 h-100 border-end border-secondary border-opacity-10" id="sidebar">
        <div>
                ...
                <li class="nav-item">
                    <a class="{{ request()->routeIs('owner.dashboard') ? 'sidebar-link-active' : 'sidebar-link' }}" 
                       href="{{ route('owner.dashboard') }}">
                        <i class="fa-solid fa-chart-pie sidebar-icon {{ request()->routeIs('owner.dashboard') ? 'text-danger' : 'text-muted' }}"></i> Dashboard
                    </a>
                </li>
            </ul>
            ...
            <ul class="nav flex-column gap-1 mb-3">
                <li class="nav-item">
                    ...
                    href="{{ route ('owner.product') }}">
                        <i class="fa-solid fa-boxes-stacked sidebar-icon text-muted"></i> Products
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="sidebar-link" href="#">
                        <i class="fa-solid fa-warehouse sidebar-icon text-muted"></i> Stock Management
                    </a>
                </li>
            </ul>
            ...
            <ul class="nav flex-column gap-1 mb-3">
                <li class="nav-item">
                    <a class="sidebar-link" href="#">
                        <i class="fa-solid fa-chart-line sidebar-icon text-muted"></i> Reports
                    </a>
                </li>
                <li class="nav-item">
                    <a class="sidebar-link" href="#">
                        <i class="fa-solid fa-shop sidebar-icon text-muted"></i> Branches
                    </a>
                </li>
                <li class="nav-item">
                    <a class="sidebar-link" href="#">
                        <i class="fa-solid fa-comment-sms sidebar-icon text-muted"></i> SMS Notifications
                    </a>
                </li>
                <li class="nav-item">
                    <a class="sidebar-link" href="#">
                        <i class="fa-solid fa-users-gear sidebar-icon text-muted"></i> User Management
                    </a>
                </li>
            </ul>
            ...
            <ul class="nav flex-column gap-1 mb-3">
                <li class="nav-item">
                    <a class="sidebar-link" href="#">
                        <i class="fa-solid fa-gear sidebar-icon text-muted"></i> Settings
                    </a>
                </li>
            </ul>
            ...
            <ul class="nav flex-column gap-1 mb-3">
                <li class="nav-item">
                    <a class="sidebar-link" href="#">
                        <i class="fa-solid fa-user-circle sidebar-icon text-muted"></i> Profile
                    </a>
                </li>
            </ul>
        </div>

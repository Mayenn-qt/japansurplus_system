    ...
    <div class="col-lg-4">
        <div class="dashboard-card p-4 h-100 position-relative overflow-hidden">
            ...
            <div class="mt-3 d-flex flex-column gap-2 small">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <span class="fw-medium text-black"><span class="badge rounded-circle me-1" style="width: 8px; height: 8px; display: inline-block; background-color: #64748b;"></span> Bacon Branch</span>
                    <div class="d-flex align-items-center gap-2">
                        <span class="text-black-50">₱100</span>
